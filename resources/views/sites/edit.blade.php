    ...
    <div class="row">
            ...
            <hr>
                ...
                <div class="row" id="contact-add">
                    ...
                    @forelse($site->contacts as $index => $contact)
                        ...
                        <div class="col-xs-12">
                            <fieldset class="form-group">
                                <input type="text" id="company_name{{$index}}" name="company_name[]" class="form-control" placeholder="Company Name"  maxlength="255" value="{{$contact->company_name}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>

                        <div class="col-xs-6">
                            <fieldset class="form-group">
                                <input type="text" id="first_name{{$index}}" name="first_name[]" class="form-control" placeholder="First Name" required maxlength="255" value="{{$contact->first_name}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>
                        <div class="col-xs-6">
                            <fieldset class="form-group">
                                <input type="text" id="last_name{{$index}}" name="last_name[]" class="form-control" placeholder="Last Name" maxlength="255" value="{{$contact->last_name}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>

                        <div class="col-xs-12">
                            <fieldset class="form-group">
                                <input type="text" id="title{{$index}}" name="title[]" class="form-control" placeholder="Title"  maxlength="255" value="{{$contact->title}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>

                        <div class="col-xs-3">
                            <fieldset class="form-group">
                                <input type="text" id="home_number{{$index}}" name="home_number[]" class="form-control home_number" placeholder="Home Number" value="{{$contact->home_number}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>
                        <div class="col-xs-3">
                            <fieldset class="form-group">
                                <input type="text" id="work_number{{$index}}" name="work_number[]" class="form-control work_number" placeholder="Work Number" value="{{$contact->work_number}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>
                        <div class="col-xs-3">
                            <fieldset class="form-group">
                                <input type="text" id="cell_number{{$index}}" name="cell_number[]" class="form-control cell_number" placeholder="Cell Number" value="{{$contact->cell_number}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>
                        <div class="col-xs-3">
                            <fieldset class="form-group">
                                <input type="text" id="fax_number{{$index}}" name="fax_number[]" class="form-control fax_number" placeholder="Fax Number" value="{{$contact->fax_number}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>

                        <div class="col-xs-5">
                            <fieldset class="form-group">
                                <input type="text" id="email{{$index}}" name="email[]" class="form-control" placeholder="Email" maxlength="255" data-parsley-type="email" value="{{$contact->email}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>
                        <div class="col-xs-5">
                            <fieldset class="form-group">
                                <input type="text" id="alternate_email{{$index}}" name="alternate_email[]" class="form-control" placeholder="Altername Email" maxlength="255" data-parsley-type="email" value="{{$contact->alternate_email}}" tabindex="{{$tabindex+=1}}">
                            </fieldset>
                        </div>
                        <div class="col-xs-2">
                            <fieldset class="form-group">
                                <a id="remove-contact-{{$index}}" class="btn btn-danger btn-sm btn-block remove-contact" tabindex="{{$tabindex+=1}}"><i class="glyphicon glyphicon-remove"></i></a>
                            </fieldset>
                        </div>
                ...
                {{ Form::textarea('property_note',null, array('class' => 'form-control', 'tabindex'=>$tabindex+=1))}}
                </fieldset>
        ...
        <div class="col-md-4">
            <div class="well">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Form::submit('Update', ['class' => 'btn btn-success btn-block', 'id'=>'site-submit', 'tabindex'=>$tabindex+=1] )}}

                    </div>
                    <div class="col-sm-6">
                        <a href="{{url()->previous()}}" id="site-cancel" class="btn btn-danger btn-block" tabindex="{{$tabindex+=1}}">Cancel</a>
                    </div>
                </div>
